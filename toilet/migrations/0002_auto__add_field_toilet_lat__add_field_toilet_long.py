...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Toilet.long'
        db.add_column(u'toilet_toilet', 'long',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Toilet.long'
        db.delete_column(u'toilet_toilet', 'long')
    ...
    models = {
        ...
        u'toilet.toilet': {
            ...
            'long': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '6'}),
